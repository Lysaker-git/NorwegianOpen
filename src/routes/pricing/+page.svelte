<script lang="ts">
    ...
    const tiers = [
        { name: 'Ymir', title: '❄️ Ymir', subtitle: 'Early Bird', deadline: 'Ends Oct 31st' },
        { name: 'Midgard', title: '🌍 Midgard', subtitle: 'Regular', deadline: 'Ends Dec 31st' },
        { name: 'Ragnarok', title: '🔥 Ragnarok', subtitle: 'Late Bird', deadline: 'From Jan 1st' }
    ];
            ...
            regions: [
                {
                    region: 'Nordic',
                    prices: [
                        { amount: 900, note: 'Free against Judging' },
                        { amount: 1000, note: 'Free against Judging' },
                        { amount: 1100, note: 'Free against Judging' }
                    ]
                },
                {
                    region: 'World',
                    prices: [
                        { amount: 750, note: 'Free against Judging' },
                        { amount: 850, note: 'Free against Judging' },
                        { amount: 950, note: 'Free against Judging' }
                    ]
                }
            ]
        },
