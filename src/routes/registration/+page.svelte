...
<script lang="ts">
	...
	const YMIR_DEADLINE_STRING = '2026-05-31'; // End of Early Bird - SET YOUR DATE
	const MIDGARD_DEADLINE_STRING = '2026-08-22'; // End of Regular - SET YOUR DATE
    ...
    const REG_OPEN_STRING = '2026-05-01';
