...
<script lang="ts">
	...
	const YMIR_DEADLINE_STRING = '2024-10-31'; // End of Early Bird - SET YOUR DATE
	const MIDGARD_DEADLINE_STRING = '2024-12-31'; // End of Regular - SET YOUR DATE
    ...
    const PARTY_PASS_PRICE = 800; // Set your party pass price
