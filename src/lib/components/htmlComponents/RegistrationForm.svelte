...
<div class="text-white">
    <form method="POST" action="?/register" use:enhance class="space-y-6">
        ...
        <!-- Role -->
        <div>
            <label for="role" class="block text-sm font-medium text-white">Preferred Role *</label>
        ...
        <!-- Partner Name -->
        <div>
            <label for="partnerName" class="block text-sm font-medium text-white">Partner Name</label>
        ...
        <div class="flex items-center">
            ...
            <label for="competing" class="ml-2 block text-sm text-white"> Are you planning to compete? </label>
        </div>
    
        <div class="">
            <label for="hotel" class="block text-sm font-medium text-white">Will you book your hotel with us?</label>
            <select id="hotel" name="Hotel" required
                    class="mt-1 block w-full px-3 py-2 border text-black rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
                <option class="text-black" value="" selected>Select Hotel Option</option>
                <option class="text-black" value="None">Will stay with someone else / already booked</option>
                <option class="text-black" value="HotelOptionOne">Twin Room (1490 NOK)</option>
                <option class="text-black" value="HotelOptionTwo">Tripple Room (1690 NOK)</option>
                <option class="text-black" value="HotelOptionThree">Quatro Room (2140 NOK)</option>
                <option class="text-black" value="HotelOptionFour">No</option>
            </select>
            {#if form?.field === 'Role'} 
                <p class="text-red-600 text-sm mt-1">{form.error}</p> 
            {/if}
